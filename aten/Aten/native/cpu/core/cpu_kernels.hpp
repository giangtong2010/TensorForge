...
namespace xpu {
    ...
    template <typename T>
    void kernel_add_CPU(at::TensorIterator iter);
...
namespace xpu {
    ...
    template <typename T>
    void kernel_sub_CPU(at::TensorIterator iter);
...
namespace xpu {
    ...
    template <typename T>
    void kernel_mul_CPU(at::TensorIterator iter);
...
namespace xpu {
    ...
    template <typename T>
    void kernel_div_CPU(at::TensorIterator iter);
